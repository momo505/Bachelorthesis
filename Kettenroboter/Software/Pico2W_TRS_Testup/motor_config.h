...
// ========================= MOTOR A/B CONFIG =========================
#define MOTOR_R_ADDR 0x5A // Antriebsmotor 
#define MOTOR_L_ADDR 0x5B // Antriebsmotor
...
#define TOTAL_SUBSTEPS (4*CPR)
#define SUBSTEPS_TO_METERS (WHEEL_DIAMETER / TOTAL_SUBSTEPS)
